...
/**
 * This ProtocolSocketFactory is used when we would like to allow an SSL
 * connection where the certificate chain cannot be verified (self-signed
 * certificate) or when there is a domain mis-match on the certificate (typical
 * for development; dangerous for production).
 * 
